...
public class Player : NetworkBehaviour
{
    ...
    {
        Debug.Log("PlayerDataChanged>>" + newPlayerData);
    ...
    {
        Debug.Log("OnClientStart>> up all events to handlers in PlayerUI");
